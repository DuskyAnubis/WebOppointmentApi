...
namespace WebOppointmentApi.Data
{
    public static class DbInitializer
    {
        public static void Initialize(ApiContext context)
        {
            ...
            //var organazitions = new List<Orgnazition>
            //{
            //    new Orgnazition{ Name="预约诊疗平台",Code="System",OrgTypeCode="",OrgTypeName="", Parent=0,Tel="",Address="",Info="部门根目录", KeyWord="",LogoUrl="",PicUrl="", Status ="正常"},
            //    new Orgnazition{ Name="信息中心",Code="InfoCenter",OrgTypeCode="03",OrgTypeName="其他部门", Parent=1,Tel="",Address="",Info="信息中心", KeyWord="",LogoUrl="",PicUrl="", Status ="正常"}
            //};
            ...
            //    new Permission{Name="部门管理",Code="OrgnazitionManager",Parent=2,Path="",Property="菜单",Description="部门管理",Icon="",Order=3,Status="正常" },
            ...
            //    new Permission{Name="预约取号",Code="TakeOppointment",Parent=3,Path="",Property="菜单",Description="预约取号",Icon="",Order=1,Status="正常" },
            //    new Permission{Name="医生排班",Code="DoctorScheduling",Parent=3,Path="",Property="菜单",Description="医生排班",Icon="",Order=2,Status="正常" }
            //};
